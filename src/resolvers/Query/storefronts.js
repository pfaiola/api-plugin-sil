 ...
 */
export default async function storefronts(_, { shopIds, ...connectionArgs }, context, info) {
  let decodedShopIds;
  ...
  const query = await context.queries.storefronts(context, { shopIds: decodedShopIds });
